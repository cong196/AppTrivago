...
(1, 'Lakeview Villas And Viet Nam', 2455600, 'https://imgec.trivago.com/partnerimages/18/02/180235620_x.jpeg', '15 Tran Phu Street, 670000, Đà Lạt, Việt Nam', 'Khách sạn', 'lakeviewvillas.com', 1, '0969340321', '1100101100', '2017-10-05 16:39:44', 0, 1, 0, 10.773388313390146, 106.65980268269777, 0),
(5, 'Ngoc Phat', 1336300, 'https://imgec.trivago.com/partnerimages/22/00/220066432_x.jpeg', '10 Hồ Tùng Mậu, 670000, Đà Lạt, Việt Nam', '', '', 2, '', '1100101100', '2017-09-29 15:38:48', 0, 1, 0, 10.757015054347724, 106.65971651673318, 0),
...
--
ALTER TABLE `hinhanh`
  ADD CONSTRAINT `hinhanh_ibfk_1` FOREIGN KEY (`idks`) REFERENCES `khachsan` (`id`) ON DELETE CASCADE;
